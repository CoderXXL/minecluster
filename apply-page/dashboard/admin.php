...
<html lang="de-DE" dir="ltr">
  ...
  <a class="item" href="logout.php">
    ...
    <div class="ui container">
      <h1>Accounts</h1>
      <br>
      <a href="addaccount.php" class="ui primary button" title="Füge einen User hinzu">Add Account</a>
      <a href="remaccount.php" class="ui danger button disabled" title="In progress">Del Account</a>
