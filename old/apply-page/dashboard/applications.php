...
<html lang="en" dir="ltr">
  ...
  <div class="column">
    <h1 style="text-align: left;">Builder applications <font color="#28BB39"><?php echo $statusgreen?></font></h1>
  ...
  <div class="column">
    <h1 style="text-align: left;">Supporter applications <font color="#28BB39"><?php echo $statusgreen?></font></h1>
    <div class="ui segment"><table class="ui celled table">
  <thead>
    <tr>
      <th>ID</th>
  ...
  <div class="column">
    <h1 style="text-align: left;">Developer applications <font color="#28BB39"><?php echo $statusgreen?></font></h1>
    <div class="ui segment"><table class="ui celled table">
  <thead>
    <tr>
      <th>ID</th>
  ...
  <div class="column">
    <h1 style="text-align: left;">Moderator applications <font color="#CC3022"><?php echo $statusred?></font></h1>
    <div class="ui segment"><table class="ui celled table">
  <thead>
    <tr>
      <th>ID</th>
  ...
  <div class="column">
    <h1 style="text-align: left;">Teamleader applications <font color="#CC3022"><?php echo $statusred?></font></h1>
    <div class="ui segment"><table class="ui celled table">
  <thead>
    <tr>
      <th>ID</th>
  ...
  <div class="column">
    <h1 style="text-align: left;">Admin applications <font color="#CC3022"><?php echo $statusred?></font></h1>
    <div class="ui segment"><table class="ui celled table">
  <thead>
    <tr>
      <th>ID</th>
