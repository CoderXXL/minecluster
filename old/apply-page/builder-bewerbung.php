...
<?php include("assets/php/header.php"); ?>
		...
		$subject 		= "Neue Builder Bewerbung";
...
?>
        ...
        <div style="width:800px; margin:0 auto;">
            ...
            <div class="Schrift1">
                <i class="fa fa-paper-plane" aria-hidden="true"></i> Builder Bewerbungsformular
            </div>
        <br>
            <form role="form" class="well" method="post" action="builder-bewerbung.php">
